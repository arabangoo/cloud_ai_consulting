...
그 후, "노트북 인스턴스" 항목을 클릭한다.
<img width="1600" alt="image1" src="https://github.com/user-attachments/assets/a77dd2e1-9c7b-46bd-8049-a1de6d0ff586">
...
(1) R : R 프로그래밍 언어를 사용하여 노트북을 생성할 수 있는 커널입니다. 주로 통계 분석과 데이터 시각화에 사용된다.
...
![image5](https://github.com/user-attachments/assets/23a68fc6-9db3-4fcc-913a-7b309248d13a)


6. ChatGPT에서 간단한 코드를 받아 복사한 후 SageMaker Jupyter에서 코드를 실행해보자.
...
7. 로컬 PC에서 주피터 노트북을 실행했을 때와 동일하게 SageMaker 노트북에서도 코드가 정상 동작하는 것을 확인할 수 있다.
